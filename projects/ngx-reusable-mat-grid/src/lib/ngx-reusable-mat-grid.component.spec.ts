...
import { GridConfig, ColumnType } from './models';
...
describe('NgxReusableMatGridComponent - TestWrapperComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [NgxReusableMatGridComponent, TestWrapperComponent],
      providers: [
        {
          provide: DatePipe,
          useValue: {
...
describe('NgxReusableMatGridComponent', () => {
  ...
  it('should test defaultSortColumn, verticalScrollOffsetInRows and requirePagination input properties', async () => {
    const mockVerticalScrollOffsetInRows = 1;
    component.defaultSortColumn = { name: 'name', sortDirection: 'desc' };
    component.verticalScrollOffsetInRows = mockVerticalScrollOffsetInRows;
    ...
    expect(component.tableScrollStyle).toEqual({
      'max-height': `${56 * (mockVerticalScrollOffsetInRows + 1)}px`,
      'overflow-y': 'auto'
    });
  });
  ...
  it('should test isStickyHeader method - with pagination', () => {
    expect(component.isStickyHeader()).toBeFalse();
    component.verticalScrollOffsetInRows = 1;
